...
| MP-13 | 3 / MP-10–12 | Partially complete | The separate public tree passed the final 76-test suite, skill validation, link checks, privacy inspection and Gitleaks scan. Public README, security guidance and offline CI are ready. Files: `README*`, `SECURITY.md`, `TEST_REPORT.md`, `.github/workflows/test.yml`, `.gitignore`, `AGENTS.md`, this roadmap. | Commit the sanitized tree, create and push the public repository, inspect Git history, verify remote HEAD and update this record. No real model was executed. |
